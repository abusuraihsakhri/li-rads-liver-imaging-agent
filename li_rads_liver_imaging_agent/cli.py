"""
Command-Line Interface for LiverRADS Sentinel: CT/MRI LI-RADS Hepatocellular Carcinoma Diagnostic Agent.
"""
import argparse
import csv
import json
...
from .agents import LiverRADSCoordinator
...
def main(argv=None):
    ...
    if args.command == "audit":
        ...
        print(f"  Domain: Abdominal Radiology | Standard: ACR PI-RADS v2.1 & LI-RADS v2018")
