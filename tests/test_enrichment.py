"""
Automated Pytest for li-rads-liver-imaging-agent Enrichment Modules.
"""
import sys
...
from enrichment import (
    ...
    LiradsV2018DecisionTreeEngine,
    MajorFeatureCounterEngine,
    TreatmentAllocationMappingEngine,
    TransplantEligibilityCriteriaEngine,
    TreatmentResponseAssessmentMrecistEngine,
    IncidentalomaProtocolEngine,
    LiradsliverimagingagentEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = LiradsliverimagingagentEnrichmentSuite()
