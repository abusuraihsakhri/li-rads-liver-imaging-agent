"""
FastAPI REST API Server for Li Rads Liver Imaging Agent.
"""
...
app = FastAPI(
    title="Li Rads Liver Imaging Agent API",
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "li-rads-liver-imaging-agent", "domain": "Radiology & Neuroimaging Systems", "standard": "ACR RADS / Fleischner Society / ASPECTS Guidelines", "version": "3.0.0-ENTERPRISE"}
